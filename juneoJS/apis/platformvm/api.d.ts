...
export declare class PlatformVMAPI extends JRPCAPI {
     ...
     */
    getJUNEAssetID: (refresh?: boolean) => Promise<Buffer>;
    /**
     ...
     * @returns The the provided string representing the JUNE AssetID
     */
    setJUNEAssetID: (juneAssetID: string | Buffer) => void;
    /**
     ...
     */
    createBlockchain: (username: string, password: string, subnetID: Buffer | string, vmID: string, fxIDs: number[], name: string, genesis: string, chainAssetID?: Buffer | string) => Promise<string>;
    /**
     ...
     */
    exportJUNE: (username: string, password: string, amount: BN, to: string) => Promise<string | ErrorResponseObject>;
    /**
     * Send JUNE from an account on the P-Chain to an address on the X-Chain. This transaction
     ...
     * by calling issueTx.
     */
    importJUNE: (username: string, password: string, to: string, sourceChain: string) => Promise<string | ErrorResponseObject>;
    /**
     ...
     * @returns An unsigned transaction created from the passed in parameters.
     */
    buildCreateChainTx: (utxoset: UTXOSet, fromAddresses: string[], changeAddresses: string[], subnetID?: string | Buffer, chainName?: string, vmID?: string, fxIDs?: string[], genesisData?: string | GenesisData, memo?: PayloadBase | Buffer, asOf?: BN, subnetAuthCredentials?: [number, Buffer][], chainAssetID?: string | Buffer) => Promise<UnsignedTx>;
    /**
     * @ignore
     */
