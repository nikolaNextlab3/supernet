...
export declare class EVMAPI extends JRPCAPI {
     ...
     * @returns String representing the transaction id
     */
    exportJUNE: (username: string, password: string, to: string, amount: BN) => Promise<string>;
    /**
     ...
     * by calling issueTx.
     */
    importJUNE: (username: string, password: string, to: string, sourceChain: string) => Promise<string>;
    /**
     ...
     */
    buildExportTx: (amount: BN, assetID: Buffer | string, destinationChain: Buffer | string, fromAddressHex: string, fromAddressBech: string, toAddresses: string[], nonce?: number, locktime?: BN, threshold?: number, fee?: BN, feeToExport?: BN) => Promise<UnsignedTx>;
    /**
     ...
     */
    constructor(core: JuneoCore, baseURL: string, blockchainID: string);
    /**
