...
export declare class UTXOSet extends StandardUTXOSet<UTXO> {
     ...
     *
     */
    buildExportTx: (networkID: number, blockchainID: Buffer, amount: BN, juneAssetID: Buffer, toAddresses: Buffer[], fromAddresses: Buffer[], changeAddresses?: Buffer[], destinationChain?: Buffer, fee?: BN, feeAssetID?: Buffer, asOf?: BN, locktime?: BN, threshold?: number, feeToExport?: BN) => UnsignedTx;
}
